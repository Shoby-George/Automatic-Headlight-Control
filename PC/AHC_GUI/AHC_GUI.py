...
class AHCFrame ( wx.Frame ):
    def __init__( self, parent ):
        ...
        wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = wx.EmptyString, pos = wx.DefaultPosition, size = wx.Size( 810,490 ), style = 0|wx.TAB_TRAVERSAL )
        ...
        bsV12 = wx.BoxSizer( wx.VERTICAL )
		
        self.gX = wx.Gauge( self, wx.ID_ANY, 360, wx.DefaultPosition, wx.DefaultSize, wx.GA_VERTICAL )
        self.gX.SetValue( 180 ) 
        bsV12.Add( self.gX, 1, wx.ALL|wx.EXPAND, 5 )
        
        self.gY = wx.Gauge( self, wx.ID_ANY, 360, wx.DefaultPosition, wx.DefaultSize, wx.GA_VERTICAL )
        self.gY.SetValue( 180 ) 
        bsV12.Add( self.gY, 1, wx.ALL|wx.EXPAND, 5 )
        
        bsH1.Add( bsV12, 1, wx.EXPAND, 5 )
        
        self.SetSizer( bsH1 )
        self.Layout()
        
        self.tUpdate = wx.Timer()
        self.tUpdate.SetOwner( self, wx.ID_ANY )
        ...
        self.Bind( wx.EVT_TIMER, self.updateXY, id=wx.ID_ANY )
        ...
        self._lightStates = [1]*10  # 0: Not Detected & 1: Detected
        ...
        self._servoThread = threading.Thread(target=self._runServoLoop)
        self._servoThread.start()

    def _runServoLoop(self):
        while self._running:
            self._angleX = randint(0,360)
            self._angleY = randint(0,360)
    ...
    def updateXY( self, event ):
        self.gX.SetValue(self._angleX)
        self.gY.SetValue(self._angleY)
    def onClose( self, event ):
        self._running = False
        self._captureThread.join()
        self._servoThread.join()
        self.Destroy()
